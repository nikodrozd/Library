...
public class BookController {
    ...
    public ResponseEntity<Book> getBookById (@PathVariable long id) {
        return new ResponseEntity<>(bookService.getBookById(id), new HttpHeaders(), HttpStatus.OK);
    }

    @PostMapping("/api/books")
    public ResponseEntity<Book> createNewBook (@Valid @RequestBody Book book) {
        return new ResponseEntity<>(bookService.addNewBook(book), new HttpHeaders(), HttpStatus.CREATED);
    }

    @PutMapping("/api/books/{id}")
    public ResponseEntity<Book> editBookById (@PathVariable long id, @Valid @RequestBody Book book) {
        return new ResponseEntity<>(bookService.editBookById(id, book), new HttpHeaders(), HttpStatus.OK);
    }
